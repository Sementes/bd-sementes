...
begin
    ...
    #db.run   CREATE TABLE plants(plant_id INTEGER PRIMARY KEY,
    #         Nome TEXT,
    #         Apelido TEXT,
    #         Foto BYTEA,
    #         NomeCientificos TEXT,
    #         NumeroSementes INTEGER,
    #         NumeroDias TEXT,
    #         NecessidadeSementesHA TEXT,
    #         CicloDiasInv TEXT,
    #         CicloDiasVer TEXT,
    #         Espacamento TEXT,
    #         EpocaPlantioR1 TEXT,
    ...
    db.run('
        CREATE TABLE plants (
            ...
            plant_alias                 VARCHAR(50)      NULL,
            plant_complete_name         VARCHAR(100) NOT NULL,
            plant_description           VARCHAR(512) NOT NULL,
            plant_foto                  BYTEA            NULL,
            plant_badges                BYTEA            NULL,
            plant_cientific_name_1      VARCHAR(255) NOT NULL,
            plant_cientific_name_2      VARCHAR(255)     NULL,
            plant_cientific_name_3      VARCHAR(255)     NULL,
            plant_seed_quantity         INT          NOT NULL,
            plant_seed_necessity_ha     VARCHAR(20)  NOT NULL,
            plant_quantity_ha           VARCHAR(45)      NULL,
            plant_grow_time             VARCHAR(20)  NOT NULL,
            plant_cycle_ver             INT              NULL,
            plany_cycle_inv             INT              NULL,
            plant_size                  VARCHAR(512) NOT NULL,
            plant_spacing               VARCHAR(20)  NOT NULL,
            plant_npk_necessity_g       VARCHAR(25)      NULL,
            plant_esterco_necessity_g   VARCHAR(25)      NULL,
            plant_water_necessity_ml    VARCHAR(25)      NULL,
            plant_region_1              VARCHAR(10)  NOT NULL,
            plant_region_2              VARCHAR(10)  NOT NULL,
            plant_region_3              VARCHAR(10)  NOT NULL,
            creation_datetime           TIMESTAMP    NOT NULL,
            last_edition                TIMESTAMP    NOT NULL,
    ...
    plantas.each do |e|
        ...
        plants_db = db.from(:plants)

        # Adicionamos a entrada
        # Forma correta, tem que ter cuidado com SQL Injection :X
        plants_db.insert(   :plant_id               => e[1].id,
                            :plant_name             => e[1].nome,
                            :plant_alias            => e[1].apelido,
                            :plant_complete_name    => e[1].nome.to
                            :Foto                   => e[1].foto,
